# -*- coding: utf-8 -*-
"""
Created on Tue Oct 24 12:27:59 2017
...
class RomanNumeralConverter(object):
    ...
    def convert_to_decimal(self, roman_numeral):
        ...
        if val > 4000:
            raise Exception("Yli 4000 arvot ei valideja")
        return val
    
    def convert_to_roman(self, roman_decimal):
        if roman_decimal > 4000:
            raise Exception("Yli 4000 arvot nou passaa")
        val = ""
        mappers = [(1000, "M"), (500, "D"), (100, "C"), (50, "L"), (10, "X"), (5, "V"), (1, "I")]
        for (mapper_dec, mapper_rom) in mappers:
            while roman_decimal >= mapper_dec:
                val += mapper_rom
                roman_decimal -= mapper_dec
        return val
